...
MODEL_UNZIPPED_NAME = vosk-model-small-en-us-0.15
...
$(MODEL_UNZIPPED):
	...
	wget -nc $(MODEL_URL)
	unzip $(MODEL_ZIP)
	mv -n $(MODEL_UNZIPPED_NAME) $(MODEL_DIR)
	rm -f $(MODEL_ZIP)
...
vic-cloud: gettoolchain voskopusbuild go_deps
	...
	CC=${HOME}/.anki/vicos-sdk/dist/$(TOOLCHAIN_VER)/prebuilt/bin/arm-oe-linux-gnueabi-clang \
	CXX=${HOME}/.anki/vicos-sdk/dist/$(TOOLCHAIN_VER)/prebuilt/bin/arm-oe-linux-gnueabi-clang++ \
